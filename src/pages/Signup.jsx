...
import { Loader2, ArrowLeft, Mail, Lock, Github, Chrome, UserPlus } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    if (error) {
      ...
      toast.success('Welcome to Bulletin Board!');
      navigate('/');
    } else {
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSignup} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-slate-300 text-xs font-medium uppercase tracking-wider">Full Name</Label>
                <div className="relative">
                  <Input
                    ...
                    className="bg-slate-950 border-slate-800 text-white focus:ring-primary focus:border-primary h-11"
                  />
                </div>
              </div>
              <div className="space-y-2">
